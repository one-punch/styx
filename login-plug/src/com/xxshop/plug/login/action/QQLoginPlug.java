 package com.xxshop.plug.login.action;
 ...
 public class QQLoginPlug
 {
     ...
     throws IOException
   {
     ...
     String auth_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + 
       ...
       "&redirect_uri=" + 
       redirect_uri + 
       "&state=xxshop&scope=get_user_info";
   ...
   public String qq_login_bind(HttpServletRequest request, HttpServletResponse response, String code)
   {
     ...
     if (SecurityUserHolder.getCurrentUser() == null) {
       ...
       return "redirect:" + CommUtil.getURL(request) + 
         ...
         "xxshop_thid_login_" + user.getPassword();
     }
   ...
   public static void main(String[] args)
   {
     ...
     String redirect_uri = 
       CommUtil.encode("http://xxshop.eicp.net/qq_login_bind.htm");
     String auth_url = "https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=" + 
