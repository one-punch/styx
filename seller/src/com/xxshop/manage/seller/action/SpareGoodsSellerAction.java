...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class SpareGoodsSellerAction
 {
   ...
   @SecurityMapping(title="闲置商品列表", value="/seller/spare_goods.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="发布闲置商品", value="/seller/add_spare_goods.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="闲置商品信息编辑", value="/seller/spare_goods_edit.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="闲置商品信息删除", value="/seller/spare_goods_dele.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="闲置商品下架上架操作", value="/seller/spare_goods_updown.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="闲置商品保存", value="/seller/spare_goods_save.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="闲置商品发布页Ajax加载下级地区信息", value="/seller/sparegoods_area_data.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片删除", value="/seller/sparegoods_removeimg.htm*", rtype="seller", rname="用户中心", rcode="user_center", rgroup="用户中心", display = false, rsequence = 0)
