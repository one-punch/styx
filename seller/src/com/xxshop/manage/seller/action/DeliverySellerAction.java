...
import com.xxshop.foundation.domain.query.DeliveryGoodsQueryObject;
import com.xxshop.foundation.domain.query.DeliveryLogQueryObject;
import com.xxshop.foundation.domain.query.GoodsQueryObject;
import com.xxshop.foundation.service.IDeliveryGoodsService;
import com.xxshop.foundation.service.IDeliveryLogService;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class DeliverySellerAction
 {
   ...
   @SecurityMapping(title="买就送", value="/seller/delivery.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送套餐购买日志", value="/seller/delivery_log.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送套餐购买", value="/seller/delivery_buy.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送套餐购买保存", value="/seller/delivery_buy_save.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送套餐购买成功", value="/seller/delivery_buy_success.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送套餐购买失败", value="/seller/delivery_buy_error.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="申请买就送", value="/seller/delivery_apply.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="加载买就送商品", value="/seller/delivery_goods.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送商品保存", value="/seller/delivery_apply_save.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="买就送删除", value="/seller/delivery_del.htm*", rtype="seller", rname="买就送", rcode="delivery_seller", rgroup="促销管理", display = false, rsequence = 0)
