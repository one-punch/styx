...
import com.xxshop.foundation.domain.GoodsReturnLog;
...
import com.xxshop.foundation.service.IGoodsReturnLogService;
...
import com.xxshop.foundation.service.IRefundLogService;
...
import com.xxshop.manage.admin.tools.PaymentTools;
import com.xxshop.pay.alipay.config.AlipayConfig;
import com.xxshop.pay.alipay.util.AlipaySubmit;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class OrderSellerAction
 {
   ...
   @SecurityMapping(title="卖家订单详情", value="/seller/order_view.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家取消订单", value="/seller/order_cancel.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家调整订单费用", value="/seller/order_fee.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="线下付款确认", value="/seller/seller_order_outline.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家确认发货", value="/seller/order_shipping.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家退款", value="/seller/order_refund.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家退货", value="/seller/order_return.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家评价", value="/seller/order_evaluate.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="打印订单", value="/seller/order_print.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家物流详情", value="/seller/ship_view.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家物流详情", value="/seller/order_query_userinfor.htm*", rtype="seller", rname="订单管理", rcode="order_seller", rgroup="交易管理", display = false, rsequence = 0)
