...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class SubAccountSellerAction
 {
   ...
   @SecurityMapping(title="子账户列表", value="/seller/sub_account_list.htm*", rtype="seller", rname="子账户管理", rcode="sub_account_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="子账户添加", value="/seller/sub_account_add.htm*", rtype="seller", rname="子账户管理", rcode="sub_account_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="子账户编辑", value="/seller/sub_account_edit.htm*", rtype="seller", rname="子账户管理", rcode="sub_account_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="子账户保存", value="/seller/sub_account_save.htm*", rtype="seller", rname="子账户管理", rcode="sub_account_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="子账户删除", value="/seller/sub_account_del.htm*", rtype="seller", rname="子账户管理", rcode="sub_account_seller", rgroup="店铺设置", display = false, rsequence = 0)
