...
import com.xxshop.foundation.domain.query.CombinLogQueryObject;
import com.xxshop.foundation.domain.query.GoodsQueryObject;
import com.xxshop.foundation.service.ICombinLogService;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class CombinSellerAction
 {
   ...
   @SecurityMapping(title="组合销售", value="/seller/combin.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售购买日志", value="/seller/combin_log.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="申请组合销售", value="/seller/combin_apply.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="销售组合编辑", value="/seller/combin_edit.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售保存", value="/seller/combin_save.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售删除", value="/seller/combin_del.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售套餐购买", value="/seller/combin_buy.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售套餐购买保存", value="/seller/combin_buy_save.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售套餐购买成功", value="/seller/combin_buy_success.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="组合销售套餐购买失败", value="/seller/combin_buy_error.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="加载商品", value="/seller/combin_goods.htm*", rtype="seller", rname="组合销售", rcode="combin_seller", rgroup="促销管理", display = false, rsequence = 0)
