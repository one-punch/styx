...
import com.xxshop.foundation.domain.query.StoreNavigationQueryObject;
import com.xxshop.foundation.service.IStoreNavigationService;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class StoreNavSellerAction
 {
   ...
   @SecurityMapping(title="卖家导航管理", value="/seller/store_nav.htm*", rtype="seller", rname="导航管理", rcode="store_nav_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家导航添加", value="/seller/store_nav_add.htm*", rtype="seller", rname="导航管理", rcode="store_nav", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家导航编辑", value="/seller/store_nav_edit.htm*", rtype="seller", rname="导航管理", rcode="store_nav", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家导航保存", value="/seller/store_nav_save.htm*", rtype="seller", rname="导航管理", rcode="store_nav", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家导航删除", value="/seller/store_nav_del.htm*", rtype="seller", rname="导航管理", rcode="store_nav", rgroup="店铺设置", display = false, rsequence = 0)
