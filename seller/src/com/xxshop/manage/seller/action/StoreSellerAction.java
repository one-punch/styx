...
import com.xxshop.core.tools.QRCodeEncoderHandler;
...
import com.xxshop.foundation.service.IStoreSlideService;
...
import com.xxshop.view.web.tools.AreaViewTools;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class StoreSellerAction
 {
   ...
   @SecurityMapping(title="申请店铺第一步", value="/seller/store_create_first.htm*", rtype="buyer", rname="申请店铺", rcode="create_store", rgroup="申请店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="申请店铺第二步", value="/seller/store_create_second.htm*", rtype="buyer", rname="申请店铺", rcode="create_store", rgroup="申请店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="申请店铺完成", value="/seller/store_create_finish.htm*", rtype="buyer", rname="申请店铺", rcode="create_store", rgroup="申请店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺设置", value="/seller/store_set.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺设置保存", value="/seller/store_set_save.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   public ModelAndView store_set_save(HttpServletRequest request, HttpServletResponse response, String area_id, String store_second_domain) {
	...
	try{
			saveFilePathName = request.getSession().getServletContext()
			.getRealPath("/")
			+ uploadFilePath + "/store_wx";
			String wxImg = store.getWeixin_qr_img() == null ? "" : store
					.getWeixin_qr_img().getName();
			map = CommUtil.saveFileToServer(request, "qr_img",					saveFilePathName, wxImg, null);
			if (wxImg.equals("")) {
				if (map.get("fileName") != "") {
					Accessory storeWxImg = new Accessory();
					storeWxImg
							.setName(CommUtil.null2String(map.get("fileName")));
					storeWxImg.setExt(CommUtil.null2String(map.get("mime")));
					storeWxImg
							.setSize(CommUtil.null2Float(map.get("fileSize")));
					storeWxImg.setPath(uploadFilePath + "/store_wx");
					storeWxImg.setWidth(CommUtil.null2Int(map.get("width")));
					storeWxImg.setHeight(CommUtil.null2Int(map.get("height")));
					storeWxImg.setAddTime(new Date());
					this.accessoryService.save(storeWxImg);
					store.setWeixin_qr_img(storeWxImg);
				}
			} 
		} catch (IOException e) {
			e.printStackTrace();
   ...
   @SecurityMapping(title="店铺地图", value="/seller/store_map.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺地图保存", value="/seller/store_map_save.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="主题设置", value="/seller/store_theme.htm*", rtype="seller", rname="主题设置", rcode="store_theme_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="主题设置", value="/seller/store_theme_save.htm*", rtype="seller", rname="主题设置", rcode="store_theme_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺认证", value="/seller/store_approve.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺认证保存", value="/seller/store_approve_save.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺升级", value="/seller/store_grade.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺升级申请完成", value="/seller/store_grade_finish.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺幻灯", value="/seller/store_slide.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺幻灯保存", value="/seller/store_slide_save.htm*", rtype="seller", rname="店铺设置", rcode="store_set_seller", rgroup="店铺设置", display = false, rsequence = 0)
