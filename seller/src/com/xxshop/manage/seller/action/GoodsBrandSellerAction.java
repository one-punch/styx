...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class GoodsBrandSellerAction extends IdEntity
 {
   ...
   @SecurityMapping(title="卖家品牌列表", value="/seller/usergoodsbrand_list.htm*", rtype="seller", rname="品牌申请", rcode="usergoodsbrand_seller", rgroup="商品管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家品牌申请", value="/seller/usergoodsbrand_add.htm*", rtype="seller", rname="品牌申请", rcode="usergoodsbrand_seller", rgroup="商品管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家品牌编辑", value="/seller/usergoodsbrand_edit.htm*", rtype="seller", rname="品牌申请", rcode="usergoodsbrand_seller", rgroup="商品管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家品牌删除", value="/seller/usergoodsbrand_dele.htm*", rtype="seller", rname="品牌申请", rcode="usergoodsbrand_seller", rgroup="商品管理", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家品牌保存", value="/seller/usergoodsbrand_save.htm*", rtype="seller", rname="品牌申请", rcode="usergoodsbrand_seller", rgroup="商品管理", display = false, rsequence = 0)
