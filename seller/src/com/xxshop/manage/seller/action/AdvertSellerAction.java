...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class AdvertSellerAction
 {
   ...
   @SecurityMapping(title="广告列表", value="/seller/advert_list.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="广告购买", value="/seller/advert_apply.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="广告购买保存", value="/seller/advert_apply_save.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="广告编辑", value="/seller/advert_apply_edit.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="我的广告", value="/seller/advert_my.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="广告延时", value="/seller/advert_delay.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="广告购买保存", value="/seller/advert_delay_save.htm*", rtype="seller", rname="广告管理", rcode="advert_seller", rgroup="其他设置", display = false, rsequence = 0)
