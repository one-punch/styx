...
import com.xxshop.foundation.domain.query.StorePartnerQueryObject;
import com.xxshop.foundation.service.IStorePartnerService;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class StorePartnerManageAction
 {
   ...
   @SecurityMapping(title="卖家合作伙伴列表", value="/seller/store_partner.htm*", rtype="seller", rname="友情链接", rcode="store_partner_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家合作伙伴添加", value="/seller/store_partner_add.htm*", rtype="seller", rname="友情链接", rcode="store_partner_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家合作伙伴编辑", value="/seller/store_partner_edit.htm*", rtype="seller", rname="友情链接", rcode="store_partner_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家合作伙伴保存", value="/seller/store_partner_save.htm*", rtype="seller", rname="友情链接", rcode="store_partner_seller", rgroup="店铺设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家合作伙伴删除", value="/seller/store_partner_del.htm*", rtype="seller", rname="友情链接", rcode="store_partner_seller", rgroup="店铺设置", display = false, rsequence = 0)
