...
import com.xxshop.foundation.domain.query.AccessoryQueryObject;
import com.xxshop.foundation.domain.query.AlbumQueryObject;
...
import com.xxshop.foundation.service.IWaterMarkService;
import com.xxshop.view.web.tools.AlbumViewTools;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class AlbumSellerAction
 {
   ...
   @SecurityMapping(title="相册列表", value="/seller/album.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="新增相册", value="/seller/album_add.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="新增相册", value="/seller/album_edit.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="相册保存", value="/seller/album_save.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片上传", value="/seller/album_upload.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="相册删除", value="/seller/album_del.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
     ...
     for (String id : ids) {
       if (!id.equals("")) {
         ...
         for (Accessory acc : accs) {
           ...
           this.databaseTools
             .execute("update xxshop_album set album_cover_id=null where album_cover_id=" + 
             acc.getId());
         }
   ...
   @SecurityMapping(title="相册封面设置", value="/seller/album_cover.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="相册转移", value="/seller/album_transfer.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片转移相册", value="/seller/album_transfer_save.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片列表", value="/seller/album_image.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片幻灯查看", value="/seller/image_slide.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="相册内图片删除", value="/seller/album_img_del.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="图片转移相册", value="/seller/album_watermark.htm*", rtype="seller", rname="图片管理", rcode="album_seller", rgroup="其他设置", display = false, rsequence = 0)
