...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class ComplaintSellerAction
 {
   ...
   @SecurityMapping(title="卖家投诉发起", value="/seller/complaint_handle.htm*", rtype="seller", rname="投诉管理", rcode="complaint_seller", rgroup="客户服务", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家被投诉列表", value="/seller/complaint.htm*", rtype="seller", rname="投诉管理", rcode="complaint_seller", rgroup="客户服务", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家查看投诉详情", value="/seller/complaint_view.htm*", rtype="seller", rname="投诉管理", rcode="complaint_seller", rgroup="客户服务", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="卖家查看投诉详情", value="/seller/complaint_appeal.htm*", rtype="seller", rname="投诉管理", rcode="complaint_seller", rgroup="客户服务", display = false, rsequence = 0)
