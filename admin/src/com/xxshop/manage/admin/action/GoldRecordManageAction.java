...
import com.xxshop.foundation.domain.query.GoldLogQueryObject;
import com.xxshop.foundation.domain.query.GoldRecordQueryObject;
import com.xxshop.foundation.service.IGoldLogService;
import com.xxshop.foundation.service.IGoldRecordService;
...
public class GoldRecordManageAction {
	...
	@SecurityMapping(title = "金币购买记录", value = "/admin/gold_record.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView gold_record(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isGold()) {
			...
			if (!CommUtil.null2String(beginCount).equals("")) {
				qo.addQuery(
						"obj.gold_count",
						new SysMap("gold_count", Integer.valueOf(CommUtil
								.null2Int(beginCount))), ">=");
			}
			if (!CommUtil.null2String(endCount).equals("")) {
				qo.addQuery(
						"obj.gold_count",
						new SysMap("endCount", Integer.valueOf(CommUtil
								.null2Int(endCount))), "<=");
			}
	...
	@SecurityMapping(title = "金币日志列表", value = "/admin/gold_log.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "金币购买记录编辑", value = "/admin/gold_record_edit.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "金币购买记录", value = "/admin/gold_record_save.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "金币购买记录删除", value = "/admin/gold_record_del.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
		...
		if (this.configService.getSysConfig().isGold()) {
			...
			for (String id : ids) {
				if (!id.equals("")) {
					...
					this.goldrecordService.delete(Long.valueOf(Long
							.parseLong(id)));
				}
			}
		}
	...
	@SecurityMapping(title = "金币购买记录", value = "/admin/gold_record_view.htm*", rtype = "admin", rname = "金币管理", rcode = "gold_record_admin", rgroup = "运营", display = false, rsequence = 0)
