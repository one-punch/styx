...
import com.xxshop.foundation.domain.query.AreaQueryObject;
...
public class AreaManageAction {
	...
	@SecurityMapping(title = "地区列表", value = "/admin/area_list.htm*", rtype = "admin", rname = "常用地区", rcode = "admin_area_set", rgroup = "设置", display = false, rsequence = 0)
	...
	public ModelAndView area_list(HttpServletRequest request,
		...
		if ((pid == null) || (pid.equals(""))) {
			...
			params = "&pid=" + pid;
			Area parent = this.areaService.getObjById(Long.valueOf(Long
					.parseLong(pid)));
	...
	@SecurityMapping(title = "地区保存", value = "/admin/area_save.htm*", rtype = "admin", rname = "常用地区", rcode = "admin_area_set", rgroup = "设置", display = false, rsequence = 0)
	...
	public ModelAndView area_save(HttpServletRequest request,
		...
		Area parent = null;
		if (!pid.equals(""))
			parent = this.areaService.getObjById(Long.valueOf(Long
					.parseLong(pid)));
	...
	@SecurityMapping(title = "地区删除", value = "/admin/area_del.htm*", rtype = "admin", rname = "常用地区", rcode = "admin_area_set", rgroup = "设置", display = false, rsequence = 0)
	...
	public String area_del(HttpServletRequest request, String mulitId,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				Set list = genericIds(this.areaService.getObjById(Long
	...
	@SecurityMapping(title = "地区导入", value = "/admin/area_import.htm*", rtype = "admin", rname = "常用地区", rcode = "admin_area_set", rgroup = "设置", display = false, rsequence = 0)
	...
	public ModelAndView area_import(HttpServletRequest request,
		...
		this.databaseTools.execute("update xxshop_store set area_id=null");

		this.databaseTools.execute("update xxshop_address set area_id=null");

		this.databaseTools.execute("update xxshop_area set parent_id=null");

		this.databaseTools.execute("delete from xxshop_area");
	...
	public ModelAndView area_export(HttpServletRequest request,
		...
		String path = request.getSession().getServletContext().getRealPath("/")
				...
				+ "base.sql";
		String tables = "xxshop_accessory,xxshop_adv_pos,xxshop_advert,xxshop_articleclass,xxshop_article,xxshop_document,xxshop_navigation,xxshop_template,xxshop_sysconfig";
	...
	@SecurityMapping(title = "地区Ajax编辑", value = "/admin/area_ajax.htm*", rtype = "admin", rname = "常用地区", rcode = "admin_area_set", rgroup = "设置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/area_ajax.htm" })
	public void area_ajax(HttpServletRequest request,
			HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
		Area obj = this.areaService
