...
import com.xxshop.foundation.service.IPredepositService;
...
public class UserManageAction {
	...
	@SecurityMapping(title = "会员添加", value = "/admin/user_add.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "会员编辑", value = "/admin/user_edit.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员", display = false, rsequence = 0)
	...
	public ModelAndView user_edit(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView("admin/blue/user_add.html",
				...
				this.userConfigService.getUserConfig(), 0, request, response);
		mv.addObject("obj",
				this.userService.getObjById(Long.valueOf(Long.parseLong(id))));
		mv.addObject("edit", Boolean.valueOf(true));
		return mv;
	}

	@SecurityMapping(title = "会员列表", value = "/admin/user_list.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "会员保存", value = "/admin/user_save.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "会员删除", value = "/admin/user_del.htm*", rtype = "admin", rname = "会员管理", rcode = "user_manage", rgroup = "会员", display = false, rsequence = 0)
	...
	public String user_del(HttpServletRequest request, String mulitId,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				User parent = this.userService.getObjById(Long.valueOf(Long
						.parseLong(id)));
	...
	@SecurityMapping(title = "会员通知", value = "/admin/user_msg.htm*", rtype = "admin", rname = "会员通知", rcode = "user_msg", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "会员通知发送", value = "/admin/user_msg_send.htm*", rtype = "admin", rname = "会员通知", rcode = "user_msg", rgroup = "会员", display = false, rsequence = 0)
	...
	public ModelAndView user_msg_send(HttpServletRequest request,
		...
		if (type.equals("the_store")) {
			...
			// for (user = 0; user < localUser1; user++) {
	...
	@SecurityMapping(title = "会员信用", value = "/admin/user_creditrule.htm*", rtype = "admin", rname = "会员信用", rcode = "user_creditrule", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "买家信用保存", value = "/admin/user_creditrule_save.htm*", rtype = "admin", rname = "会员信用", rcode = "user_creditrule", rgroup = "会员", display = false, rsequence = 0)
