...
import com.xxshop.foundation.domain.query.GoodsBrandQueryObject;
import com.xxshop.foundation.domain.query.GoodsFloorQueryObject;
...
import com.xxshop.foundation.service.IGoodsFloorService;
...
import com.xxshop.manage.admin.tools.GoodsFloorTools;
...
public class GoodsFloorManageAction {
	...
	@SecurityMapping(title = "楼层分类列表", value = "/admin/goods_floor_list.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层分类添加", value = "/admin/goods_floor_add.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层分类编辑", value = "/admin/goods_floor_edit.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层分类保存", value = "/admin/goods_floor_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层分类删除", value = "/admin/goods_floor_del.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层分类Ajax更新", value = "/admin/goods_floor_ajax.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	@RequestMapping({ "/admin/goods_floor_ajax.htm" })
	public void goods_floor_ajax(HttpServletRequest request,
			HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
		GoodsFloor obj = this.goodsfloorService.getObjById(Long.valueOf(Long
				.parseLong(id)));
	...
	@SecurityMapping(title = "楼层分类下级加载", value = "/admin/goods_floor_data.htm*", rtype = "admin", rname = "分类管理", rcode = "goods_class", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板编辑", value = "/admin/goods_floor_template.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板商品分类编辑", value = "/admin/goods_floor_class.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板商品分类加载", value = "/admin/goods_floor_class_load.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板商品分类保存", value = "/admin/goods_floor_class_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板分类商品编辑", value = "/admin/goods_floor_gc_goods.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板分类商品保存", value = "/admin/goods_floor_gc_goods_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板右侧商品列表编辑", value = "/admin/goods_floor_list_goods.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板右侧商品列表保存", value = "/admin/goods_floor_list_goods_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板左下方广告编辑", value = "/admin/goods_floor_left_adv.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板左下方广告保存", value = "/admin/goods_floor_left_adv_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板右下方广告编辑", value = "/admin/goods_floor_right_adv.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板右下方广告保存", value = "/admin/goods_floor_right_adv_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板品牌编辑", value = "/admin/goods_floor_brand.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板品牌保存", value = "/admin/goods_floor_brand_save.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板品牌加载", value = "/admin/goods_floor_brand_load.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "楼层模板分类商品编辑", value = "/admin/goods_floor_list_goods_load.htm*", rtype = "admin", rname = "首页楼层", rcode = "goods_floor", rgroup = "商品", display = false, rsequence = 0)
	...
	public ModelAndView goods_floor_list_goods_load(HttpServletRequest request,
		...
		if (!CommUtil.null2String(gc_id).equals("")) {
			Set ids = genericIds(this.goodsClassService.getObjById(CommUtil
					.null2Long(gc_id)));
