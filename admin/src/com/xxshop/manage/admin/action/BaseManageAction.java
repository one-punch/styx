...
import com.xxshop.core.annotation.Log;
...
import com.xxshop.foundation.domain.LogType;
...
public class BaseManageAction {
	...
	public void login_success(HttpServletRequest request,
		...
		if ((this.configService.getSysConfig().isIntegral())
				&& ((user.getLoginDate() == null) || (user.getLoginDate()
						.before(CommUtil.formatDate(CommUtil
		...
		if (this.configService.getSysConfig().isSecond_domain_open()) {
			Cookie user_session = new Cookie("user_session", user.getId()
					.toString());
	...
	public ModelAndView login_error(HttpServletRequest request,
		...
		String view_type = CommUtil.null2String(request.getSession(false)
				.getAttribute("xxshop_view_type"));
		if ((view_type != null) && (!view_type.equals(""))) {
			if (view_type.equals("weixin")) {
	...
	@SecurityMapping(title = "商城后台管理", value = "/admin/index.htm*", rtype = "admin", rname = "商城后台管理", rcode = "admin_index", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "欢迎页面", value = "/admin/welcome.htm*", rtype = "admin", rname = "欢迎页面", rcode = "admin_index", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "关于我们", value = "/admin/aboutus.htm*", rtype = "admin", rname = "关于我们", rcode = "admin_index", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "站点设置", value = "/admin/set_site.htm*", rtype = "admin", rname = "站点设置", rcode = "admin_set_site", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "上传设置", value = "/admin/set_image.htm*", rtype = "admin", rname = "上传设置", rcode = "admin_set_image", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "保存商城配置", value = "/admin/sys_config_save.htm*", rtype = "admin", rname = "保存商城配置", rcode = "admin_config_save", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "Email设置", value = "/admin/set_email.htm*", rtype = "admin", rname = "Email设置", rcode = "admin_set_email", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "短信设置", value = "/admin/set_sms.htm*", rtype = "admin", rname = "短信设置", rcode = "admin_set_sms", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "SEO设置", value = "/admin/set_seo.htm*", rtype = "admin", rname = "SEO设置", rcode = "admin_set_seo", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "二级域名设置", value = "/admin/set_second_domain.htm*", rtype = "admin", rname = "二级域名设置", rcode = "admin_set_second_domain", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "二级域名设置保存", value = "/admin/set_second_domain_save.htm*", rtype = "admin", rname = "二级域名设置", rcode = "admin_set_second_domain", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "QQ互联登录", value = "/admin/set_site_qq.htm*", rtype = "admin", rname = "二级域名设置", rcode = "admin_set_second_domain", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "分润设置", value = "/admin/set_fenrun.htm*", rtype = "admin", rname = "分润管理", rcode = "admin_set_fenrun", rgroup = "设置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "保存分润设置", value = "/admin/set_fenrun_save.htm*", rtype = "admin", rname = "分润管理", rcode = "admin_set_fenrun", rgroup = "设置", display = false, rsequence = 0)
	...
	public ModelAndView authority(HttpServletRequest request,
		...
		if (domain_error) {
			mv = new JModelAndView("error.html",
					...
					this.userConfigService.getUserConfig(), 1, request,
					response);
			mv.addObject("op_title", "域名绑定错误，请与http://www.ehaowang.com联系");
		}
		return mv;
	}
	...
	public void user_msg_save(HttpServletResponse response, String msg)
		...
		PostMethod method = new PostMethod(
				"http://www.ehaowang.com/user_msg.htm");
	...
	@SecurityMapping(title = "websiteCss设置", value = "/admin/set_websiteCss.htm*", rtype = "admin", rname = "Email设置", rcode = "admin_set_websiteCss", rgroup = "设置", display = false, rsequence = 0)
