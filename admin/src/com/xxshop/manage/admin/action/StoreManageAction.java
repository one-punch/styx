...
import com.xxshop.foundation.domain.query.StoreGradeLogQueryObject;
import com.xxshop.foundation.domain.query.StoreQueryObject;
import com.xxshop.foundation.service.IAccessoryService;
import com.xxshop.foundation.service.IAlbumService;
...
import com.xxshop.foundation.service.IRoleService;
import com.xxshop.foundation.service.IStoreClassService;
import com.xxshop.foundation.service.IStoreGradeLogService;
import com.xxshop.foundation.service.IStoreGradeService;
...
import com.xxshop.manage.admin.tools.AreaManageTools;
import com.xxshop.manage.admin.tools.StoreTools;
...
public class StoreManageAction {
	...
	@SecurityMapping(title = "店铺列表", value = "/admin/store_list.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺添加1", value = "/admin/store_add.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺添加2", value = "/admin/store_new.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺编辑", value = "/admin/store_edit.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	public ModelAndView store_edit(HttpServletRequest request,
		...
		if ((id != null) && (!id.equals(""))) {
			Store store = this.storeService.getObjById(Long.valueOf(Long
					.parseLong(id)));
			List scs = this.storeClassService
					.query("select obj from StoreClass obj where obj.parent.id is null order by obj.sequence asc",
							null, -1, -1);
	...
	@SecurityMapping(title = "店铺保存", value = "/admin/store_save.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	public ModelAndView store_save(HttpServletRequest request,
		...
		if (id.equals("")) {
			...
			Store obj = this.storeService.getObjById(Long.valueOf(Long
					.parseLong(id)));
		...
		if ((grade_id != null) && (!grade_id.equals(""))) {
			store.setGrade(this.storeGradeService.getObjById(Long.valueOf(Long
					.parseLong(grade_id))));
		}
		...
		if ((user_id != null) && (!user_id.equals(""))) {
			User user = this.userService.getObjById(Long.valueOf(Long
					.parseLong(user_id)));
			user.setStore(store);
	...
	private void send_site_msg(HttpServletRequest request, String mark,
		...
		com.xxshop.foundation.domain.Template template = this.templateService
	...
	@SecurityMapping(title = "店铺删除", value = "/admin/store_del.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺AJAX更新", value = "/admin/store_ajax.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "卖家信用", value = "/admin/store_base.htm*", rtype = "admin", rname = "基本设置", rcode = "admin_store_base", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "卖家信用保存", value = "/admin/store_set_save.htm*", rtype = "admin", rname = "基本设置", rcode = "admin_store_base", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺模板", value = "/admin/store_template.htm*", rtype = "admin", rname = "店铺模板", rcode = "admin_store_template", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺模板增加", value = "/admin/store_template_add.htm*", rtype = "admin", rname = "店铺模板", rcode = "admin_store_template", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺模板保存", value = "/admin/store_template_save.htm*", rtype = "admin", rname = "店铺模板", rcode = "admin_store_template", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺升级列表", value = "/admin/store_gradelog_list.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺升级编辑", value = "/admin/store_gradelog_edit.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺升级保存", value = "/admin/store_gradelog_save.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
	...
	public ModelAndView store_gradelog_save(HttpServletRequest request,
		...
		if (log.getStore_grade_status() == -1) {
			send_site_msg(request, "msg_toseller_store_update_refuse_notify",
					log.getStore());
		}
		send_site_msg(request, "msg_toseller_store_update_allow_notify",
				log.getStore());
	...
	@SecurityMapping(title = "店铺升级日志查看", value = "/admin/store_gradelog_view.htm*", rtype = "admin", rname = "店铺管理", rcode = "admin_store_set", rgroup = "店铺", display = false, rsequence = 0)
