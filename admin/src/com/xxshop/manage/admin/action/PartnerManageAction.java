...
import com.xxshop.foundation.domain.query.PartnerQueryObject;
import com.xxshop.foundation.service.IAccessoryService;
import com.xxshop.foundation.service.IPartnerService;
...
public class PartnerManageAction {
	...
	@SecurityMapping(title = "合作伙伴列表", value = "/admin/partner_list.htm*", rtype = "admin", rname = "合作伙伴", rcode = "partner_manage", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "合作伙伴添加", value = "/admin/partner_add.htm*", rtype = "admin", rname = "合作伙伴", rcode = "partner_manage", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "合作伙伴编辑", value = "/admin/partner_edit.htm*", rtype = "admin", rname = "合作伙伴", rcode = "partner_manage", rgroup = "网站", display = false, rsequence = 0)
	...
	public ModelAndView edit(HttpServletRequest request,
		...
		if ((id != null) && (!id.equals(""))) {
			Partner partner = this.partnerService.getObjById(Long.valueOf(Long
					.parseLong(id)));
	...
	@SecurityMapping(title = "合作伙伴保存", value = "/admin/partner_save.htm*", rtype = "admin", rname = "合作伙伴", rcode = "partner_manage", rgroup = "网站", display = false, rsequence = 0)
	...
	public ModelAndView save(HttpServletRequest request,
		...
		if (id.equals("")) {
			...
			Partner obj = this.partnerService.getObjById(Long.valueOf(Long
					.parseLong(id)));
	...
	@SecurityMapping(title = "合作伙伴删除", value = "/admin/partner_del.htm*", rtype = "admin", rname = "合作伙伴", rcode = "partner_manage", rgroup = "网站", display = false, rsequence = 0)
