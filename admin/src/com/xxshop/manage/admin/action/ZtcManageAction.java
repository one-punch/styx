...
import com.xxshop.foundation.domain.query.ZTCGoldLogQueryObject;
...
public class ZtcManageAction {
	...
	@SecurityMapping(title = "直通车设置", value = "/admin/ztc_set.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "直通车设置保存", value = "/admin/ztc_set_save.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "直通车申请列表", value = "/admin/ztc_apply.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView ztc_apply(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isZtc_status()) {
			...
			qo.addQuery("obj.ztc_status",
					new SysMap("ztc_status", Integer.valueOf(1)), "=");
			...
			if (!CommUtil.null2String(ztc_status).equals("")) {
				qo.addQuery(
						"obj.ztc_status",
						new SysMap("ztc_status", Integer.valueOf(CommUtil
								.null2Int(ztc_status))), "=");
			}
	...
	@SecurityMapping(title = "直通车商品审核", value = "/admin/ztc_apply_edit.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "直通车商品查看", value = "/admin/ztc_apply_view.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "直通车商品审核保存", value = "/admin/ztc_apply_save.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "直通车商品", value = "/admin/ztc_goods.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView ztc_goods(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isZtc_status()) {
			GoodsQueryObject qo = new GoodsQueryObject(currentPage, mv,
					"ztc_apply_time", "desc");
			qo.addQuery("obj.ztc_status",
					new SysMap("ztc_status", Integer.valueOf(2)), "=");
			if (!CommUtil.null2String(goods_name).equals("")) {
				qo.addQuery("obj.goods_name", new SysMap("goods_name", "%"
						+ goods_name.trim() + "%"), "like");
			}
	...
	@SecurityMapping(title = "直通车金币日志", value = "/admin/ztc_gold_log.htm*", rtype = "admin", rname = "竞价直通车", rcode = "ztc_set", rgroup = "运营", display = false, rsequence = 0)
