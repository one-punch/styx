...
import com.xxshop.foundation.domain.query.ComplaintSubjectQueryObject;
...
public class ComplaintSubjectManageAction {
	...
	@SecurityMapping(title = "投诉主题列表", value = "/admin/complaintsubject_list.htm*", rtype = "admin", rname = "投诉管理", rcode = "complaint_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "投诉主题添加", value = "/admin/complaintsubject_add.htm*", rtype = "admin", rname = "投诉管理", rcode = "complaint_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "投诉主题编辑", value = "/admin/complaintsubject_edit.htm*", rtype = "admin", rname = "投诉管理", rcode = "complaint_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "投诉主题保存", value = "/admin/complaintsubject_save.htm*", rtype = "admin", rname = "投诉管理", rcode = "complaint_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	public ModelAndView save(HttpServletRequest request,
		...
		if (id.equals("")) {
			complaintsubject = (ComplaintSubject) wf.toPo(request,
	...
	@SecurityMapping(title = "投诉主题删除", value = "/admin/complaintsubject_del.htm*", rtype = "admin", rname = "投诉管理", rcode = "complaint_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	public String delete(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				ComplaintSubject complaintsubject = this.complaintsubjectService
						.getObjById(Long.valueOf(Long.parseLong(id)));
				this.complaintsubjectService.delete(Long.valueOf(Long
						.parseLong(id)));
			}
		}
