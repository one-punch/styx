...
import com.xxshop.foundation.domain.query.ReportTypeQueryObject;
...
public class ReportTypeManageAction {
	...
	@SecurityMapping(title = "举报类型列表", value = "/admin/reporttype_list.htm*", rtype = "admin", rname = "举报管理", rcode = "report_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "举报类型增加", value = "/admin/reporttype_add.htm*", rtype = "admin", rname = "举报管理", rcode = "report_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "举报类型编辑", value = "/admin/reporttype_edit.htm*", rtype = "admin", rname = "举报管理", rcode = "report_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "举报类型保存", value = "/admin/reporttype_save.htm*", rtype = "admin", rname = "举报管理", rcode = "report_manage", rgroup = "交易", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "举报类型删除", value = "/admin/reporttype_del.htm*", rtype = "admin", rname = "举报管理", rcode = "report_manage", rgroup = "交易", display = false, rsequence = 0)
