...
import com.xxshop.foundation.domain.query.PredepositCashQueryObject;
import com.xxshop.foundation.service.IPredepositCashService;
...
public class PredepositCashManageAction {
	...
	@SecurityMapping(title = "提现申请列表", value = "/admin/predeposit_cash.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "提现申请编辑", value = "/admin/predeposit_cash_edit.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "提现申请编辑保存", value = "/admin/predeposit_cash_save.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "提现申请详情", value = "/admin/predeposit_cash_view.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
