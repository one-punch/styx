...
public class UcenterManageAction {
	...
	@SecurityMapping(title = "UC配置", value = "/admin/ucenter.htm*", rtype = "admin", rname = "UC整合", rcode = "admin_bbs", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "UC信息保存", value = "/admin/ucenter_save.htm*", rtype = "admin", rname = "UC整合", rcode = "admin_bbs", rgroup = "工具", display = false, rsequence = 0)
