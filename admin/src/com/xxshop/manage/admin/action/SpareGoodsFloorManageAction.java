...
import com.xxshop.foundation.domain.query.SpareGoodsClassQueryObject;
import com.xxshop.foundation.domain.query.SpareGoodsFloorQueryObject;
import com.xxshop.foundation.domain.query.SpareGoodsQueryObject;
import com.xxshop.foundation.service.IAccessoryService;
import com.xxshop.foundation.service.IAdvertPositionService;
import com.xxshop.foundation.service.IAdvertService;
import com.xxshop.foundation.service.ISpareGoodsClassService;
import com.xxshop.foundation.service.ISpareGoodsFloorService;
import com.xxshop.foundation.service.ISpareGoodsService;
...
public class SpareGoodsFloorManageAction {
	...
	@SecurityMapping(title = "闲置商品楼层列表", value = "/admin/sparegoodsfloor_list.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_list.htm" })
	public ModelAndView floor_list(HttpServletRequest request,
			HttpServletResponse response, String currentPage, String orderBy,
			String orderType) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_list.html",
	...
	@SecurityMapping(title = "闲置商品楼层添加", value = "/admin/sparegoodsfloor_add.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_add.htm" })
	public ModelAndView floor_add(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_add.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		List sgcs = this.sparegoodsclassService
				.query("select obj from SpareGoodsClass obj where obj.parent.id is null",
						null, -1, -1);
		...
		List advertposition = this.advertPositionService
				.query("select obj from AdvertPosition obj where obj.ap_width=:width and obj.ap_height=:height and obj.ap_type=:ap_type order by addTime asc",
						params, -1, -1);
	...
	@SecurityMapping(title = "闲置商品楼层编辑", value = "/admin/sparegoodsfloor_edit.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_edit.htm" })
	public ModelAndView floor_edit(HttpServletRequest request,
	...
	@SecurityMapping(title = "闲置商品楼层保存", value = "/admin/sparegoodsfloor_save.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_save.htm" })
	public ModelAndView floor_save(HttpServletRequest request,
			HttpServletResponse response, String id, String currentPage,
			String cmd, String list_url, String add_url, String cid,
			String advert_url, String ap_id, String advert_type) {
		WebForm wf = new WebForm();
		SpareGoodsFloor sparegoodsfloor = null;
		if (id.equals("")) {
			sparegoodsfloor = (SpareGoodsFloor) wf.toPo(request,
					SpareGoodsFloor.class);
			sparegoodsfloor.setAddTime(new Date());
		} else {
			SpareGoodsFloor obj = this.sparegoodsfloorService.getObjById(Long
					.valueOf(Long.parseLong(id)));
			sparegoodsfloor = (SpareGoodsFloor) wf.toPo(request, obj);
		}
		SpareGoodsClass sgc = this.sparegoodsclassService.getObjById(CommUtil
				.null2Long(cid));
		sparegoodsfloor.setSgc(sgc);
		if ((ap_id != null) && (!ap_id.equals(""))) {
			AdvertPosition adp = this.advertPositionService.getObjById(CommUtil
					.null2Long(ap_id));
		...
		try {
			...
			if (fileName.equals("")) {
				...
				advert_img.setName(CommUtil.null2String(map.get("fileName")));
				advert_img.setExt(CommUtil.null2String(map.get("mime")));
				advert_img.setSize(CommUtil.null2Float(map.get("fileSize")));
				advert_img.setPath(uploadFilePath + "/advert");
				advert_img.setWidth(CommUtil.null2Int(map.get("width")));
				advert_img.setHeight(CommUtil.null2Int(map.get("height")));
				advert_img.setAddTime(new Date());
	...
	@SecurityMapping(title = "闲置商品楼层ajax更新", value = "/admin/sparegoodsfloor_ajax.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_ajax.htm" })
	public void floor_ajax(HttpServletRequest request,
	...
	@SecurityMapping(title = "闲置商品楼层删除", value = "/admin/sparegoodsfloor_del.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_del.htm" })
	public String floor_delete(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				SpareGoodsFloor sparegoodsfloor = this.sparegoodsfloorService
						.getObjById(Long.valueOf(Long.parseLong(id)));
				this.sparegoodsfloorService.delete(Long.valueOf(Long
						.parseLong(id)));
			}
		}
	...
	@SecurityMapping(title = "闲置商品楼层分类设置", value = "/admin/sparegoodsfloor_setclass.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_setclass.htm" })
	public ModelAndView floor_setclass(HttpServletRequest request,
			HttpServletResponse response, String currentPage, String orderBy,
			String orderType, String fid) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_setclass.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsClassQueryObject qo = new SpareGoodsClassQueryObject(
				currentPage, mv, orderBy, orderType);
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil
				.null2Long(fid));
	...
	@SecurityMapping(title = "商品楼层分类ajax更新", value = "/admin/sparegoodsfloor_class_ajax.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_class_ajax.htm" })
	public void floor_class_ajax(HttpServletRequest request,
			HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
	...
	@SecurityMapping(title = "闲置商品楼层分类设置是否显示", value = "/admin/sparegoodsfloor_setclass_switch.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_setclass_switch.htm" })
	public String floor_setclass_switch(HttpServletRequest request,
			HttpServletResponse response, String currentPage, String fid,
	...
	@SecurityMapping(title = "闲置商品楼层商品设置", value = "/admin/sparegoodsfloor_setgoods.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_setgoods.htm" })
	public ModelAndView floor_setgoods(HttpServletRequest request,
			HttpServletResponse response, String currentPage, String orderBy,
			String orderType, String fid) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoodsfloor_setgoods.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		SpareGoodsFloor sgf = this.sparegoodsfloorService.getObjById(CommUtil
				.null2Long(fid));
		...
		List<SpareGoods> sgs = this.sparegoodsService
				.query("select obj from SpareGoods obj where obj.sgf.id is null and  obj.spareGoodsClass.id in (:ids)",
						map, -1, -1);
	...
	@SecurityMapping(title = "闲置商品楼层商品设置是否显示", value = "/admin/sparegoodsfloor_setgoods_switch.htm*", rtype = "admin", rname = "闲置楼层", rcode = "sparegoodsfloor_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoodsfloor_setgoods_switch.htm" })
	public String floor_setgoods_switch(HttpServletRequest request,
