...
import com.xxshop.foundation.domain.Advert;
...
import com.xxshop.foundation.domain.query.AdvertPositionQueryObject;
import com.xxshop.foundation.domain.query.AdvertQueryObject;
...
import com.xxshop.foundation.service.IGoldLogService;
...
public class AdvertManageAction {
	...
	@SecurityMapping(title = "广告列表", value = "/admin/advert_list.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "待审批广告列表", value = "/admin/advert_list_audit.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView advert_list_audit(HttpServletRequest request,
		...
		qo.addQuery("obj.ad_status",
				new SysMap("ad_status", Integer.valueOf(0)), "=");
		IPageList pList = this.advertService.list(qo);
		CommUtil.saveIPageList2ModelAndView("", "", "", pList, mv);
		mv.addObject("ad_title", ad_title);
		return mv;
	...
	@SecurityMapping(title = "广告增加", value = "/admin/advert_add.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告编辑", value = "/admin/advert_edit.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView advert_edit(HttpServletRequest request,
		...
		if ((id != null) && (!id.equals(""))) {
			Advert advert = this.advertService.getObjById(Long.valueOf(Long
					.parseLong(id)));
			List aps = this.advertPositionService.query(
					"select obj from AdvertPosition obj", null, -1, -1);
			mv.addObject("aps", aps);
	...
	@SecurityMapping(title = "广告查看", value = "/admin/advert_view.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告审核", value = "/admin/advert_audit.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView advert_audit(HttpServletRequest request,
		...
		if ((obj.getAd_status() == 1)
				&& (obj.getAd_ap().getAp_show_type() == 0)) {
	...
	@SecurityMapping(title = "广告保存", value = "/admin/advert_save.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView advert_save(HttpServletRequest request,
		...
		if (id.equals("")) {
			...
			Advert obj = this.advertService.getObjById(Long.valueOf(Long
					.parseLong(id)));
	...
	@SecurityMapping(title = "广告删除", value = "/admin/advert_del.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告位添加", value = "/admin/adv_pos_add.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告位保存", value = "/admin/adv_pos_save.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告位列表", value = "/admin/adv_pos_list.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告位编辑", value = "/admin/adv_pos_edit.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "广告位删除", value = "/admin/adv_pos_del.htm*", rtype = "admin", rname = "广告管理", rcode = "advert_admin", rgroup = "运营", display = false, rsequence = 0)
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				if (ap.getAp_sys_type() != 0) {
					...
					this.advertPositionService.delete(Long.valueOf(Long
							.parseLong(id)));
				}
			}
		}
