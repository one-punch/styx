...
public class PredepositManageAction {
	...
	@SecurityMapping(title = "预存款列表", value = "/admin/predeposit_list.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	public ModelAndView predeposit_list(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isDeposit()) {
			...
			if (!CommUtil.null2String(pd_status).equals("")) {
				qo.addQuery(
						"obj.pd_status",
						new SysMap("pd_status", Integer.valueOf(CommUtil
								.null2Int(pd_status))), "=");
			}
	...
	@SecurityMapping(title = "预存款编辑", value = "/admin/predeposit_edit.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "预存款保存", value = "/admin/predeposit_save.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "预存款手动修改", value = "/admin/predeposit_modify.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "加载用户预存款信息", value = "/admin/predeposit_user.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "预存款手动修改保存", value = "/admin/predeposit_modify_save.htm*", rtype = "admin", rname = "预存款管理", rcode = "predeposit", rgroup = "会员", display = false, rsequence = 0)
