...
import com.xxshop.foundation.domain.query.IntegralGoodsQueryObject;
...
public class IntegralGoodsManageAction {
	...
	@SecurityMapping(title = "积分礼品列表", value = "/admin/integral_goods.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView integral_goods(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isIntegralStore()) {
			...
			if (!CommUtil.null2String(ig_show).equals("")) {
				qo.addQuery(
						"obj.ig_show",
						new SysMap("ig_show", Boolean.valueOf(CommUtil
								.null2Boolean(ig_show))), "=");
			}
	...
	@SecurityMapping(title = "积分礼品添加", value = "/admin/integral_goods_add.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "积分礼品编辑", value = "/admin/integral_goods_edit.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "积分礼品保存", value = "/admin/integral_goods_save.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	@RequestMapping({ "/admin/integral_goods_save.htm" })
	public ModelAndView integral_goods_save(HttpServletRequest request,
			HttpServletResponse response, String id, String currentPage,
			String begin_hour, String end_hour, String list_url, String add_url) {
	...
	@SecurityMapping(title = "积分礼品删除", value = "/admin/integral_goods_del.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public String integral_goods_del(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				this.integralgoodsService.delete(Long.valueOf(Long
						.parseLong(id)));
			}
		}
	...
	@SecurityMapping(title = "积分礼品兑换列表", value = "/admin/integral_order.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView integral_order(HttpServletRequest request,
		...
		if (this.configService.getSysConfig().isIntegralStore()) {
			...
			if (!CommUtil.null2String(igo_status).equals("")) {
				qo.addQuery(
						"obj.igo_status",
						new SysMap("igo_status", Integer.valueOf(CommUtil
								.null2Int(igo_status))), "=");
			}
	...
	@SecurityMapping(title = "积分礼品兑换详情", value = "/admin/integral_order_view.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "取消积分订单", value = "/admin/integral_order_cancel.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "订单确认付款", value = "/admin/integral_order_payok.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "订单删除", value = "/admin/integral_order_del.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "订单费用调整", value = "/admin/integral_order_fee.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "订单费用调整保存", value = "/admin/integral_order_fee_save.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "发货设置", value = "/admin/integral_order_ship.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "发货设置保存", value = "/admin/integral_order_ship_save.htm*", rtype = "admin", rname = "积分商城", rcode = "integral_goods_admin", rgroup = "运营", display = false, rsequence = 0)
	@RequestMapping({ "/admin/integral_order_ship_save.htm" })
	public String integral_order_ship_save(HttpServletRequest request,
			HttpServletResponse response, String id, String currentPage,
			String igo_ship_code, String igo_ship_time, String igo_ship_content) {
		IntegralGoodsOrder obj = this.integralGoodsOrderService
				.getObjById(CommUtil.null2Long(id));
		if (this.configService.getSysConfig().isIntegralStore()) {
