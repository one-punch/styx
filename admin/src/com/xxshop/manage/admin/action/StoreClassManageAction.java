...
import com.xxshop.foundation.domain.query.StoreClassQueryObject;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class StoreClassManageAction
 {
   ...
   @SecurityMapping(title="店铺分类列表", value="/admin/storeclass_list.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类添加", value="/admin/storeclass_add.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类编辑", value="/admin/storeclass_edit.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类保存", value="/admin/storeclass_save.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类删除", value="/admin/storeclass_del.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类AJAX保存", value="/admin/storeclass_ajax.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
   ...
   @SecurityMapping(title="店铺分类下级数据加载", value="/admin/storeclass_data.htm*", rtype="admin", rname="店铺分类", rcode="store_class", rgroup="店铺", display = false, rsequence = 0)
