...
import com.xxshop.foundation.domain.query.ArticleClassQueryObject;
import com.xxshop.foundation.service.IArticleClassService;
...
public class ArticleClassManageAction {
	...
	@SecurityMapping(title = "文章分类列表", value = "/admin/articleclass_list.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "文章分类添加", value = "/admin/articleclass_add.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	...
	public ModelAndView add(HttpServletRequest request,
		...
		if ((pid != null) && (!pid.equals(""))) {
			...
			obj.setParent(this.articleClassService.getObjById(Long.valueOf(Long
					.parseLong(pid))));
	...
	@SecurityMapping(title = "文章分类编辑", value = "/admin/articleclass_edit.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "文章分类保存", value = "/admin/articleclass_save.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "文章分类删除", value = "/admin/articleclass_del.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	@RequestMapping({ "/admin/articleclass_del.htm" })
	public String delete(HttpServletRequest request, String mulitId) {
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if (!id.equals("")) {
				Set list = genericIds(this.articleClassService.getObjById(Long
						.valueOf(Long.parseLong(id))));
				Map params = new HashMap();
				params.put("ids", list);
				List<ArticleClass> acs = this.articleClassService
						.query("select obj from ArticleClass obj where obj.id in (:ids) order by obj.level desc",
								params, -1, -1);
	...
	@SecurityMapping(title = "文章下级分类", value = "/admin/articleclass_data.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "文章分类AJAX更新", value = "/admin/articleclass_ajax.htm*", rtype = "admin", rname = "文章分类", rcode = "article_class", rgroup = "网站", display = false, rsequence = 0)
	@RequestMapping({ "/admin/articleclass_ajax.htm" })
	public void ajax(HttpServletRequest request, HttpServletResponse response,
			String id, String fieldName, String value)
			throws ClassNotFoundException {
		ArticleClass ac = this.articleClassService.getObjById(Long.valueOf(Long
				.parseLong(id)));
	...
	public void articleclass_verify(HttpServletRequest request,
		...
		List gcs = this.articleClassService
				.query("select obj from ArticleClass obj where obj.className=:className and obj.id!=:id",
						params, -1, -1);
