...
import com.xxshop.foundation.domain.query.ActivityGoodsQueryObject;
import com.xxshop.foundation.domain.query.ActivityQueryObject;
...
public class ActivityManageAction {
	...
	@SecurityMapping(title = "活动列表", value = "/admin/activity_list.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView activity_list(HttpServletRequest request,
		...
		if (!CommUtil.null2String(ac_status).equals("")) {
			qo.addQuery(
					"obj.ac_status",
					new SysMap("ac_status", Integer.valueOf(CommUtil
							.null2Int(ac_status))), "=");
		}
	...
	@SecurityMapping(title = "活动添加", value = "/admin/activity_add.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "活动编辑", value = "/admin/activity_edit.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "活动保存", value = "/admin/activity_save.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView activity_save(HttpServletRequest request,
		...
		if (id.equals("")) {
			...
			Activity obj = this.activityService.getObjById(Long.valueOf(Long
					.parseLong(id)));
	...
	@SecurityMapping(title = "活动删除", value = "/admin/activity_del.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "活动AJAX更新", value = "/admin/activity_ajax.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "活动商品列表", value = "/admin/activity_goods_list.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView activity_goods_list(HttpServletRequest request,
		...
		if (!CommUtil.null2String(ag_status).equals("")) {
			qo.addQuery(
					"obj.ag_status",
					new SysMap("ag_status", Integer.valueOf(CommUtil
							.null2Int(ag_status))), "=");
		}
	...
	@SecurityMapping(title = "活动通过", value = "/admin/activity_goods_audit.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public String activity_goods_audit(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				BigDecimal acprice = num.multiply(act.getAc_rebate())
						.multiply(goods.getStore_price()).setScale(2, 4);
	...
	@SecurityMapping(title = "活动拒绝", value = "/admin/activity_goods_refuse.htm*", rtype = "admin", rname = "活动管理", rcode = "activity_admin", rgroup = "运营", display = false, rsequence = 0)
