...
public class SpareGoodsManageAction {
	...
	@SecurityMapping(title = "闲置商品列表", value = "/admin/sparegoods_list.htm*", rtype = "admin", rname = "闲置商品", rcode = "sparegoods_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	public ModelAndView spare_goods(HttpServletRequest request,
		...
		if ((type != null) && (!type.equals(""))) {
			qo.addQuery(
					"obj.status",
					new SysMap("obj_status", Integer.valueOf(CommUtil
							.null2Int(type))), "=");
			mv.addObject("type", type);
		} else {
			qo.addQuery("obj.status",
					new SysMap("obj_status", Integer.valueOf(0)), "=");
		}
	...
	@SecurityMapping(title = "闲置商品下架上架切换", value = "/admin/sparegoods_switch.htm*", rtype = "admin", rname = "闲置商品", rcode = "sparegoods_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "闲置商品信息删除", value = "/admin/sparegoods_dele.htm*", rtype = "admin", rname = "闲置商品", rcode = "sparegoods_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "闲置商品AJAX更新", value = "/admin/sparegoods_ajax.htm*", rtype = "admin", rname = "闲置商品", rcode = "sparegoods_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoods_ajax.htm" })
	public void sparegoods_ajax(HttpServletRequest request,
			HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
		SpareGoods obj = this.sparegoodsService.getObjById(Long.valueOf(Long
				.parseLong(id)));
	...
	@SecurityMapping(title = "闲置商品分类列表", value = "/admin/sparegoods_class_list.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoods_class_list.htm" })
	public ModelAndView sparegoods_class_list(HttpServletRequest request,
			HttpServletResponse response, String currentPage, String orderBy,
			String orderType) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoods_class_list.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	@SecurityMapping(title = "闲置商品分类添加", value = "/admin/sparegoods_class_add.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	public ModelAndView sparegoodsclass_add(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoods_class_add.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	@SecurityMapping(title = "闲置商品分类编辑", value = "/admin/sparegoods_class_edit.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "闲置商品分类保存", value = "/admin/sparegoods_class_save.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	public ModelAndView sparegoods_class_save(HttpServletRequest request,
		...
		if (id.equals("")) {
			sparegoodsclass = (SpareGoodsClass) wf.toPo(request,
					SpareGoodsClass.class);
	...
	@SecurityMapping(title = "闲置商品分类删除", value = "/admin/sparegoods_class_del.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
		...
		for (String id : ids) {
			if (!id.equals("")) {
				...
				List<SpareGoodsClass> sgcs = this.sparegoodsclassService
						.query("select obj from SpareGoodsClass obj where obj.id in (:ids) order by obj.level desc",
								params, -1, -1);
	...
	@SecurityMapping(title = "闲置商品分类Ajax更新", value = "/admin/sparegoods_class_ajax.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "闲置商品分类下级加载", value = "/admin/sparegoods_class_data.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	@RequestMapping({ "/admin/sparegoods_class_data.htm" })
	public ModelAndView sparegoods_class_data(HttpServletRequest request,
			HttpServletResponse response, String pid) {
		ModelAndView mv = new JModelAndView(
				"admin/blue/sparegoods_class_data.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		Map map = new HashMap();
		map.put("pid", Long.valueOf(Long.parseLong(pid)));
		List gcs = this.sparegoodsclassService
				.query("select obj from SpareGoodsClass obj where obj.parent.id =:pid",
						map, -1, -1);
		mv.addObject("gcs", gcs);
		return mv;
	}

	@SecurityMapping(title = "闲置商品分类验证是否存在", value = "/admin/sparegoods_class_verify.htm*", rtype = "admin", rname = "闲置分类", rcode = "sparegoods_class_admin", rgroup = "闲置", display = false, rsequence = 0)
	...
	public void sparegoods_class_verify(HttpServletRequest request,
		...
		if (pid.equals("")) {
			sgcs = this.sparegoodsclassService
					.query("select obj from SpareGoodsClass obj where obj.className=:className",
							params, -1, -1);
		} else {
			params.put("pid", CommUtil.null2Long(pid));
			sgcs = this.sparegoodsclassService
					.query("select obj from SpareGoodsClass obj where obj.className=:className and obj.parent.id =:pid",
							params, -1, -1);
		}
		if (sgcs.size() > 0) {
			ret = false;
