...
import com.xxshop.foundation.domain.query.GroupPriceRangeQueryObject;
...
public class GroupPriceRangeManageAction {
	...
	@SecurityMapping(title = "团购价格区间列表", value = "/admin/group_price_list.htm*", rtype = "admin", rname = "团购管理", rcode = "group_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "团购价格区间列表", value = "/admin/group_price_add.htm*", rtype = "admin", rname = "团购管理", rcode = "group_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "团购价格区间列表", value = "/admin/group_price_edit.htm*", rtype = "admin", rname = "团购管理", rcode = "group_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "团购价格区间保存", value = "/admin/group_price_save.htm*", rtype = "admin", rname = "团购管理", rcode = "group_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public ModelAndView save(HttpServletRequest request,
		...
		if (id.equals("")) {
			grouppricerange = (GroupPriceRange) wf.toPo(request,
	...
	@SecurityMapping(title = "团购价格区间删除", value = "/admin/group_price_del.htm*", rtype = "admin", rname = "团购管理", rcode = "group_admin", rgroup = "运营", display = false, rsequence = 0)
	...
	public String delete(HttpServletRequest request,
		...
		for (String id : ids) {
			if (!id.equals("")) {
				GroupPriceRange grouppricerange = this.grouppricerangeService
						.getObjById(Long.valueOf(Long.parseLong(id)));
				this.grouppricerangeService.delete(Long.valueOf(Long
						.parseLong(id)));
			}
		}
