...
import com.xxshop.foundation.domain.query.StoreGradeQueryObject;
...
public class StoreGradeManageAction {
	...
	@SecurityMapping(title = "店铺等级列表", value = "/admin/storegrade_list.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺等级添加", value = "/admin/storegrade_add.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺等级编辑", value = "/admin/storegrade_edit.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺等级保存", value = "/admin/storegrade_save.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺等级删除", value = "/admin/storegrade_del.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "店铺等级AJAX更新", value = "/admin/storegrade_ajax.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	@RequestMapping({ "/admin/storegrade_ajax.htm" })
	public void storegrade_ajax(HttpServletRequest request,
			HttpServletResponse response, String id, String fieldName,
			String value) throws ClassNotFoundException {
		StoreGrade obj = this.storegradeService.getObjById(Long.valueOf(Long
				.parseLong(id)));
	...
	@SecurityMapping(title = "店铺等级模板设置", value = "/admin/storegrade_template.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
	...
	public ModelAndView storegrade_template(HttpServletRequest request,
		...
		mv.addObject("obj", this.storegradeService.getObjById(Long.valueOf(Long
				.parseLong(id))));
		mv.addObject("separator", File.separator);
		return mv;
	}

	@SecurityMapping(title = "店铺等级模板保存", value = "/admin/storegrade_template_save.htm*", rtype = "admin", rname = "店铺等级", rcode = "store_grade", rgroup = "店铺", display = false, rsequence = 0)
