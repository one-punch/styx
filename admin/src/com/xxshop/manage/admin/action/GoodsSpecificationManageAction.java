...
import com.xxshop.foundation.domain.query.GoodsSpecificationQueryObject;
...
public class GoodsSpecificationManageAction {
	...
	@SecurityMapping(title = "商品规格列表", value = "/admin/goods_spec_list.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "商品规格添加", value = "/admin/goods_spec_add.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "商品规格编辑", value = "/admin/goods_spec_edit.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "商品规格保存", value = "/admin/goods_spec_save.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	public ModelAndView save(HttpServletRequest request,
		...
		if (id.equals("")) {
			goodsSpecification = (GoodsSpecification) wf.toPo(request,
	...
	@SecurityMapping(title = "商品规格删除", value = "/admin/goods_spec_del.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "商品规格属性AJAX删除", value = "/admin/goods_property_delete.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	public void goods_property_delete(HttpServletRequest request,
		...
		if (!id.equals("")) {
			this.databaseTools
					.execute("delete from xxshop_goods_spec where spec_id="
							+ id);
			this.databaseTools
					.execute("delete from xxshop_cart_gsp where gsp_id=" + id);
	...
	@SecurityMapping(title = "商品规格AJAX更新", value = "/admin/goods_spec_ajax.htm*", rtype = "admin", rname = "规格管理", rcode = "goods_spec", rgroup = "商品", display = false, rsequence = 0)
	...
	public void goods_spec_verify(HttpServletRequest request,
		...
		List gss = this.goodsSpecService
				.query("select obj from GoodsSpecification obj where obj.name=:name and obj.id!=:id",
						params, -1, -1);
