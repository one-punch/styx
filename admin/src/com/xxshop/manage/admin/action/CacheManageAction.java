...
public class CacheManageAction {
	...
	@SecurityMapping(title = "缓存列表", value = "/admin/cache_list.htm*", rtype = "admin", rname = "更新缓存", rcode = "cache_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "更新缓存", value = "/admin/update_cache.htm*", rtype = "admin", rname = "更新缓存", rcode = "cache_manage", rgroup = "工具", display = false, rsequence = 0)
