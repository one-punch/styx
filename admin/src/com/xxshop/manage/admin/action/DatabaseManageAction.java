...
import com.xxshop.core.domain.virtual.ShopData;
import com.xxshop.core.mv.JModelAndView;
import com.xxshop.core.tools.CommUtil;
import com.xxshop.core.tools.FileSorter;
...
public class DatabaseManageAction {
	...
	@SecurityMapping(title = "数据库备份", value = "/admin/database_add.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "数据库备份保存", value = "/admin/database_backup.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	public ModelAndView database_backup(HttpServletRequest request,
		...
		ModelAndView mv = new JModelAndView("admin/blue/db.html",
				this.configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	@SecurityMapping(title = "数据库分卷备份", value = "/admin/database_bund_backup.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "数据库备份列表", value = "/admin/database_list.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "数据库备份删除", value = "/admin/database_del.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "数据库导入引导", value = "/admin/database_store.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
	...
	@SecurityMapping(title = "数据库分卷导入", value = "/admin/database_bund_store.htm*", rtype = "admin", rname = "数据库管理", rcode = "data_manage", rgroup = "工具", display = false, rsequence = 0)
