...
import org.hibernate.annotations.CacheConcurrencyStrategy;
 ...
 public class GoodsType extends IdEntity
 {
   ...
   @ManyToMany
   @JoinTable(name="xxshop_goodstype_spec", joinColumns={@javax.persistence.JoinColumn(name="type_id")}, inverseJoinColumns={@javax.persistence.JoinColumn(name="spec_id")})
   private List<GoodsSpecification> gss = new ArrayList();
 
   @ManyToMany
   @JoinTable(name="xxshop_goodstype_brand", joinColumns={@javax.persistence.JoinColumn(name="type_id")}, inverseJoinColumns={@javax.persistence.JoinColumn(name="brand_id")})
