 package com.xxshop.foundation.log;
...
import com.xxshop.foundation.domain.LogFieldType;
...
import com.xxshop.foundation.service.ISysLogService;
...
import org.springframework.stereotype.Component;
 ...
 public class SystemLogAdvice
 {
   ...
   @AfterReturning("execution(* com.xxshop.manage..*.*(..))&& @annotation(annotation)&&args(request,..) ")
   ...
   @AfterThrowing(value="execution(* com.xxshop.manage..*.*(..))&&args(request,..) ", throwing="exception")
