 package com.xxshop.core.constant;
 
 public class Globals
 {
   public static final String DEFAULT_SYSTEM_TITLE = "XXSHOP多用户商城系统";
   public static final boolean SSO_SIGN = true;
   public static final int DEFAULT_SHOP_VERSION = 20140301;
   public static final String DEFAULT_SHOP_OUT_VERSION = "V2.1";
   public static final String DEFAULT_WBESITE_NAME = "XXSHOP";
   ...
   public static final String DEFAULT_TABLE_SUFFIX = "xxshop_";
   public static final String THIRD_ACCOUNT_LOGIN = "xxshop_thid_login_";
