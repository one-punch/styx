...
import com.xxshop.core.annotation.Lock;
...
//             PropertyDescriptor pd;
             if (field.indexOf(".") > 0) {
               Class entity = Class.forName("com.xxshop.domain." + 
             ...
             boolean add = false;
             BeanWrapper localBeanWrapper2 = new BeanWrapper(propertys); 
//					  for (BeanWrapper localBeanWrapper1 = 0; localBeanWrapper1 < localBeanWrapper2; localBeanWrapper1++) { 
						  for (int i = 0; i < propertys.length; i++) {
