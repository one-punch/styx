 package com.xxshop.core.base;
 
 import com.easyjf.util.CommUtil;
import com.xxshop.core.exception.CanotRemoveObjectException;
...
import org.springframework.orm.jpa.support.JpaDaoSupport;
 ...
 public class GenericEntityDao extends JpaDaoSupport
 {
   ...
   public List<Object> find(final Class clazz, final String queryStr, final Map params, final int begin, final int max)
   {
     Class claz = clazz;
   ...
   public Object getBy(final Class clazz, final String propertyName, final Object value)
   {
     Class claz = clazz;
     List ret = (List)getJpaTemplate().execute(
       new JpaCallback()
